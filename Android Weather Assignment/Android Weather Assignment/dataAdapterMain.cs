...
namespace Android_Weather_Assignment
{
    ...
    public class dataAdapterMain : BaseAdapter<Current_observation>
    {
        int[] drawables;
        string[] conditions;
        List<Current_observation> items;

        Activity context;
        public dataAdapterMain(Activity context, List<Current_observation> items)
            : base()
        {
        ...
        public override Current_observation this[int position]
        {
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            if (view == null) // no view to re-use, create new
                view = context.LayoutInflater.Inflate(Resource.Layout.CityItemLayout, null);

            //mapping textviews with info from list of weather api objects
            view.FindViewById<TextView>(Resource.Id.tv_CityName).Text = item.Display_location.City;
            view.FindViewById<TextView>(Resource.Id.tv_CurrentTemp).Text = item.Temp_c + "°C";
